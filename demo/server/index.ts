...
app.listen(port, () => {
  ...
  console.log(`  POST /api/v1/lottery/buy             (10 sats)  body: { sparkAddress }`)
  console.log(`  GET  /api/v1/faucet/status           (free)`)
  console.log(`  POST /api/v1/faucet/claim            (free)       body: { sparkAddress }`)
  console.log(`  POST /api/v1/openai/chat/completions (1–2 sats/chunk, session)`)
})
